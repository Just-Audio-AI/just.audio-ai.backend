...
from src.schemas import UserEmail, UserEmailCodeRequest, UserTokenResponseSchema
...
async def email_auth(body: UserEmail, auth_service: AuthService = Depends(get_auth_service)):
    try:
